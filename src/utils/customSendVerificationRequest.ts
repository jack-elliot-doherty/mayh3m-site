...
export async function customSendVerificationRequest({
  ...
  console.log("email sent sucessfully", identifier);
}
                      ...
                      <tr>
                        <td class="sm-px-6" style="padding: 40px">
                          <table style="width: 100%" cellpadding="0" cellspacing="0" role="presentation">
                            <tr>
                              <td>
                                ...
                                <p class="dark-text-gray-50" style="margin: 0; font-size: 16px; line-height: 26px; color: black">
                                  ...
                                  <br>
                                  <br>
                                  We use this sign-in button for security and so you don't
                            ...
                            <tr>
                              <td>
                                <a href="${url}" class="sm-block dark-text-primary-500 dark-bg-gray-50 dark-hover-bg-gray-50" style="text-decoration: none; display: inline-block; background-color: #000; padding: 14px 24px; text-align: center; font-size: 16px; font-weight: 700; color: #f9fafb; box-shadow: 0px 2px 4px -1px rgba(0, 0, 0, 0.06), 0px 4px 6px -1px rgba(0, 0, 0, 0.1)">
                                  <!--[if mso
                                    ]><i
                                      style="
                                        letter-spacing: 24px;
                                ...
                                <p style="margin: 0; font-size: 16px color: #000">
                                  <span style="font-weight: 700 color: black">Or copy and paste the following URL into your
                                    browser:</span>
                                  <br>
